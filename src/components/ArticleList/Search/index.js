                ...
                <div className="row">
                  <div className="col-sm-12">
                    <figure className="rel  pb3">
                      <Link to={`/Article/${article.title.replace(/\s+/g, '-')}`} className="db  over-hidden  searchArticleList__img--cont">
                  ...
                  <div className="col-sm-12">
                    ...
                    <Link to={`/Article/${article.title.replace(/\s+/g, '-')}`} className="no-underline"><h2 className="black  t7  pt2  cp  title-font  over-hidden  link  searchArticleList__title">{article.title}</h2></Link>
