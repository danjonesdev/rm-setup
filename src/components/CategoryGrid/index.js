          ...
          <div className="row">
            <div className="col-sm-12  col-md-8">
              <Link className="link" to={'/Category/Artists'}>
                <div className="mv3  shadow2  CategoryGrid__bg" style={{ backgroundImage: 'url(http://res.cloudinary.com/dzz8ji5lj/image/upload/e_contrast:-100,o_100/articles/es-0909-981683-962153-back.jpg)' }}>
            ...
            <div className="col-sm-12  col-md-8">
              <Link className="link" to={'/Category/Mixes'}>
                <div className="mv3  shadow2  CategoryGrid__bg" style={{ backgroundImage: 'url(http://res.cloudinary.com/dzz8ji5lj/image/upload/e_contrast:-100,o_100/e_brightness:-40,o_100/articles/How-to-secure-DJ-gig.jpg)' }}>
            ...
            <div className="col-sm-12  col-md-8">
              <Link className="link" to={'/Category/Visuals'}>
                <div className="mv3  shadow2  CategoryGrid__bg" style={{ backgroundImage: 'url(http://res.cloudinary.com/dzz8ji5lj/image/upload/e_contrast:-100,o_100/e_brightness:-40,o_100/articles/How-to-secure-DJ-gig.jpg)' }}>
                  <h4 className="rel  tac  white  t5  title-font  CategoryGrid__title">Visuals</h4>
                </div>
              </Link>
            </div>
          </div>
